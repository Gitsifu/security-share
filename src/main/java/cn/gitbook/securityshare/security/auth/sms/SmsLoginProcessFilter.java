...
public class SmsLoginProcessFilter extends BaseLoginProcessFilter {
    ...
    protected SmsLoginProcessFilter(String defaultFilterProcessesUrl, AuthenticationSuccessHandler successHandler, AuthenticationFailureHandler failureHandler) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        SmsLoginToken smsLoginToken = new SmsLoginToken(Collections.EMPTY_LIST,phone,verifyCode);
